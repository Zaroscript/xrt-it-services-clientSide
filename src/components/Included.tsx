    ...
    <section className="page-container relative overflow-hidden bg-background text-foreground py-16 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        <motion.div
          ...
          viewport={{ amount: 0.2 }}
        >
          <h2 className="text-3xl md:text-4xl font-bold mb-4 bg-linear-gradient-to-r from-foreground via-foreground/80 to-foreground/60 bg-clip-text text-transparent">
            Why Choose XRT Tech?
          </h2>
          ...
          {marketing.map((offer, index) => (
            ...
            >
              <div className="w-full md:w-1/2 h-44 md:h-56 rounded-2xl overflow-hidden relative shadow-lg">
                <div className="absolute inset-0 bg-linear-gradient-to-br from-black/10 to-transparent z-10" />
                <Image
                  src={offer.image}
                  alt={offer.title}
                  fill
        ...
        >
          ...
          <button
            className="bg-linear-to-r from-main to-secondary hover:opacity-90 text-card-foreground dark:text-white font-medium py-3 px-8 rounded-full transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-main/30"
