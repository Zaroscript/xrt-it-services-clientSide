      ...
      {isPopular && (
        <>
          ...
          <div className="absolute right-[-41px] top-[35px] rotate-45 bg-gradient-to-r from-secondary to-secondary/80 px-12 py-1.5 shadow-lg">
            <span className="text-sm font-semibold text-[#1a1a1a]">MOST POPULAR</span>
          </div>
          {/* Glow effect */}
      ...
      <div className={cn(
        ...
        <div>
          ...
          <h2 className={cn(
            ...
            isPopular ? "bg-gradient-to-r from-secondary to-secondary/80 bg-clip-text text-transparent" : "text-[#D3B073]"
          )}>
            {price}
          </h2>
          <div className="space-y-1 text-sm text-gray-600 dark:text-gray-300">
            ...
            <p>
              <del className="text-gray-500 dark:text-gray-400">{originalPrice}</del>{" "}
              <span className={cn(
                "font-medium",
                isPopular 
                  ? "text-secondary" 
            ...
            <p className="text-gray-500 dark:text-gray-400">No commitment. Cancel Anytime.</p>
          </div>
        </div>

        <div className={cn(
          "h-px w-full",
          isPopular ? "bg-gradient-to-r from-secondary via-secondary/80 to-secondary/60" : "bg-[#D3B073]"
        )} />
        ...
        <div className="space-y-2 text-center text-sm">
          <p className="text-gray-500 dark:text-gray-400">Local taxes may apply</p>
          <div className={cn(
